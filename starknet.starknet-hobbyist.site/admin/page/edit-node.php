...
class _web extends _api
{
    ...
    {
        $sql = $this->getSql('menu_node', ['id', 'menu_id', 'name', 'url', 'juris']);
        $id = $this->is('id');
...
<body class="layui-form">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="name" class="layui-input" lay-verify="required" value="<?php echo isset($web->info['name']) ? $web->info['name'] : ''; ?>" placeholder="请输入项目名称" />
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">
        ...
        <div class="layui-input-block">
            <input type="text" name="url" class="layui-input" lay-verify="required" value="<?php echo isset($web->info['url']) ? $web->info['url'] : ''; ?>" placeholder="请输入项目地址" />
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">
...
<script>
    form.on("submit(submit)", function(data) {
        $.ajax({
            url: api.url('set') + "&id=<?php echo $web->is('id'); ?>&menu_id=<?php echo $web->is('menu_id'); ?>",
            type: 'POST',
            dataType: 'json',
            data: data.field,
            beforeSend: function() {
